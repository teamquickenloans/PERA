(function() 
{
	...
	angular
	  ...
	  .controller('DashboardController', DashboardController); //link the controller to a function DashboardController
	...
	function DashboardController($scope)
	{
	 ...
	 //            mapOptions);
		...
		/**
		* @name displayMarkers	
		* @desc Displays a marker for each garage on the map
		* @memberOf pera.dashboard.controllers.DashboardController
		*/
		function displayMarkers($scope) {
			for(var i=0; i<this.garages.length; i++) {
				this.garageMarkers[i] = new google.maps.Marker({
					map: this.map,
				...
				{
					this.garageMarkers[i].setIcon('parking_logo_green.png'); //TODO: Fix click zone
				}
				else if (this.garages[i].load == 'medium')
				{
					this.garageMarkers[i].setIcon('parking_logo_yellow.png');
				}
				else if (this.garages[i].load == 'high')
				{
					this.garageMarkers[i].setIcon('parking_logo_red.png');
				}
				else if (this.garages[i].load == 'full')
				{
					this.garageMarkers[i].setIcon('parking_logo_black.png');
				}
			}
		}
	...
	//google.maps.event.addDomListener(window, 'load', app.controller.initializeMap);
  ...
  // 		});
	...
	*/
	...
	}	//end DashboardController function
